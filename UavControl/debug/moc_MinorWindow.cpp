...
const QMetaObject MinorWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MinorWindow.data,
      qt_meta_data_MinorWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MinorWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MinorWindow.stringdata0))
        return static_cast<void*>(const_cast< MinorWindow*>(this));
